...
- Pro ist fuer `5,99 EUR / Jahr` mit Google Play Billing Produkt-ID `iptv_mat_player_pro_yearly` und Lifetime `24,99 EUR` mit Produkt-ID `iptv_mat_player_pro_lifetime` vorbereitet. Bis Billing vollstaendig implementiert ist, darf die App nur "Pro bald verfuegbar" anzeigen.
