...
import { BACKEND_URL, createPlaybackUrl, fetchM3UProxy, fetchXtreamProxy, isLikelyHls, mapLive, mapSeries, mapVod, parseM3U } from "./lib/importers.js";
...
export default function App() {
  ...
  const selectedPreferHls = isLikelyHls(selectedItem.streamUrl);
      ...
      {page === "home" ? (
        <>
          ...
          <section className="hero" style={{ backgroundImage: `linear-gradient(180deg,rgba(7,10,18,.10),rgba(7,10,18,.95)),url(${selectedItem.cover})` }}>
            ...
            <Player src={selectedPlaybackUrl} preferHls={selectedPreferHls} autoplay={settings.autoplay} onProgress={updateProgress} onEnded={completePlayback} onStatus={setStatus} onDiagnostic={updateDiagnostics} tvMode={tvMode} />
          </section>
